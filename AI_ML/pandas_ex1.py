...
a= df.iloc[:,[4]].max()  # max value

#now use a boolean logic

index_of_max_value = df.iloc[:,4].idxmax()

# Now you can use this index to select the row
row_with_max = df.loc[index_of_max_value]
print(row_with_max)

a= df [df['number_of_atoms']>5]
print(a.info)